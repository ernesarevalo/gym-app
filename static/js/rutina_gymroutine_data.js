const RUTINA_GYMROUTINE = [
  {
    "dia": 1,
    "titulo": "Día 1: Core + Espalda + Piernas",
    "ejercicios": [
      {
        "ejercicio_id": "gr_plancha_d1",
        "nombre": "Plancha Abdominal",
        "grupo_muscular": "Core",
        "descripcion": "Antebrazos y puntas de pie apoyados.",
        "tecnica": {
          "postura": "Antebrazos y puntas de pie apoyados. Cuerpo en línea recta de cabeza a talones. Clave diástasis: empujá el ombligo hacia adentro activamente.",
          "errores_comunes": "Dejar caer las caderas. Elevar demasiado el glúteo. Dejar que la panza cuelgue hacia el suelo — ese es el error más común y peligroso para la diástasis.",
          "seguridad": "Si ves que el abdomen se proyecta hacia afuera (doming), bajá las rodillas al suelo de inmediato. Es mejor la versión modificada que dañar la pared abdominal."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Espinales (Superman)",
        "grupo_muscular": "Espalda",
        "descripcion": "Boca abajo en el suelo.",
        "tecnica": {
          "postura": "Boca abajo en el suelo. Brazos extendidos al frente o manos en la nuca. Mirada siempre al piso — nunca al frente.",
          "errores_comunes": "Levantar demasiado el pecho. Mirar hacia adelante (fuerza el cuello). Hacer el movimiento con impulso.",
          "seguridad": "Elevación pequeña y controlada. El objetivo es activar la lumbar, no llegar alto. Si duele la espalda baja, reducí el rango."
        },
        "tips": [
      ...
      },
      {
        ...
        "descripcion": "Cajón detrás.",
        "tecnica": {
          "postura": "Cajón detrás. Pies a ancho de hombros, puntas levemente afuera. Barra sobre trapecios. Core activo.",
          "errores_comunes": "Desplomarse sobre el cajón. No tocar el cajón (no llegar a la profundidad). Rodillas que colapsan hacia adentro.",
          "seguridad": "Bajá controlado hasta tocar el cajón con los glúteos suavemente — sin desplomarte. El cajón es una referencia, no un apoyo. Nunca rebotes."
        },
        "tips": [
      ...
      },
      {
        ...
        "grupo_muscular": "Piernas",
        "descripcion": "Espalda completamente apoyada en el respaldo.",
        "tecnica": {
          "postura": "Espalda completamente apoyada en el respaldo. Pies a ancho de cadera, levemente adelantados en la plataforma.",
          "errores_comunes": "Despegar la espalda del respaldo. Trabar las rodillas al extender. Pies demasiado altos o bajos.",
          "seguridad": "Priorizá el rango de movimiento profundo sobre el peso. Dejá siempre una micro-flexión en la rodilla al extender."
        },
        "tips": [
      ...
      },
      {
        ...
        "grupo_muscular": "Piernas",
        "descripcion": "Pies a media altura en la plataforma, a ancho de cadera.",
        "tecnica": {
          "postura": "Pies a media altura en la plataforma, a ancho de cadera. Espalda y glúteos pegados al asiento.",
          "errores_comunes": "Trabar las rodillas. Elevar los glúteos del asiento. Pies demasiado arriba (isquios) o abajo (rodillas).",
          "seguridad": "Siempre dejá micro-flexión en la rodilla. Ajustá los seguros antes de empezar."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Camilla Femoral (Curl Femoral)",
        "grupo_muscular": "Piernas",
        "descripcion": "Boca abajo en la máquina.",
        "tecnica": {
          "postura": "Boca abajo en la máquina. Rodilla en la articulación de la palanca. Cadera pegada al asiento.",
          "errores_comunes": "Levantar la cadera para ayudar. Hacer el movimiento rápido. No llegar al rango completo.",
          "seguridad": "Movimiento lento y controlado. No uses más peso del que permita el rango completo."
        },
        "tips": [
      ...
      },
      {
        ...
        "grupo_muscular": "Piernas",
        "descripcion": "Sentado con la espalda recta apoyada en el respaldo.",
        "tecnica": {
          "postura": "Sentado con la espalda recta apoyada en el respaldo. Piernas en los apoyos abiertos.",
          "errores_comunes": "Rebotar en el punto de máxima apertura. Usar impulso para cerrar. Despegar la espalda.",
          "seguridad": "Controlá el regreso del peso — no rebotes en la apertura máxima. Eso es donde ocurren las lesiones."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Pantorrilla en Máquina / Escalón",
        "grupo_muscular": "Piernas",
        "descripcion": "Antepié en el escalón o máquina.",
        "tecnica": {
          "postura": "Antepié en el escalón o máquina. Talón libre para bajar completamente.",
          "errores_comunes": "No bajar el talón completamente. No llegar a la máxima extensión arriba. Hacer el movimiento rápido.",
          "seguridad": "Rango completo siempre. Bajá bien el talón para estirar el gemelo al máximo."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Bici Fija — Intervalos Fútbol",
        "grupo_muscular": "Core",
        "descripcion": "Postura erguida en la bici.",
        "tecnica": {
          "postura": "Postura erguida en la bici. Espalda neutra, no te inclines demasiado al frente.",
          "errores_comunes": "Ir suave en los 30 seg de sprint — tienen que ser incómodos para que sirvan. No recuperar bien en los 60 seg.",
          "seguridad": "Empezá los primeros 2 min suave antes de empezar los intervalos."
        },
        "tips": [
  ...
  {
    "dia": 2,
    "titulo": "Día 2: Brazos + Core + Espalda + Hombros + Pecho",
    "ejercicios": [
      {
        "ejercicio_id": "gr_plancha_d2",
        "nombre": "Plancha Abdominal",
        "grupo_muscular": "Core",
        "descripcion": "Antebrazos y puntas de pie.",
        "tecnica": {
          "postura": "Antebrazos y puntas de pie. Cuerpo en línea recta. Ombligo hacia la columna activamente.",
          "errores_comunes": "Caída de caderas. Panza colgando. Abdomen abultado hacia afuera.",
          "seguridad": "Si hay doming abdominal, bajá las rodillas. La forma perfecta es más importante que aguantar el tiempo."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Posterior con Mancuernas (Vuelo Posterior)",
        "grupo_muscular": "Espalda",
        "descripcion": "Sentado en el borde de un banco.",
        "tecnica": {
          "postura": "Sentado en el borde de un banco. Inclinate hacia adelante con el torso. Espalda recta, no redondeada.",
          "errores_comunes": "Usar impulso. Encorvar la espalda. Subir los brazos más de lo que permite la articulación.",
          "seguridad": "Peso liviano siempre. El deltoides posterior es pequeño y se lesiona fácil con ego."
        },
        "tips": [
      ...
      },
      {
        ...
        "descripcion": "Espalda con leve arco natural.",
        "tecnica": {
          "postura": "Espalda con leve arco natural. Pies firmes. Escápulas retraídas y deprimidas contra el banco.",
          "errores_comunes": "Rebotar la barra en el pecho en vez de pausar. Perder la tensión en la pausa. Glúteos que se levantan.",
          "seguridad": "Usá rack con seguros ajustados. Con 6x6 pesado siempre tené spotter disponible."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Press Cerrado (Tríceps)",
        "grupo_muscular": "Pecho",
        "descripcion": "Banco plano.",
        "tecnica": {
          "postura": "Banco plano. Espalda apoyada. Agarre al ancho de los hombros o algo más cerrado.",
          "errores_comunes": "Abrir los codos al subir. Bajar la barra hacia el cuello. Arquear la espalda para completar.",
          "seguridad": "Empezá conservador. El agarre cerrado cambia mucho la carga sobre codo y hombro."
        },
        "tips": [
      ...
      },
      {
        ...
        "grupo_muscular": "Pecho",
        "descripcion": "Banco a 30-45°.",
        "tecnica": {
          "postura": "Banco a 30-45°. Espalda apoyada con leve arco. Core activo.",
          "errores_comunes": "Ángulo demasiado alto (se convierte en press de hombro). Bajar la barra al cuello. Abrir mucho los codos.",
          "seguridad": "30-45° de inclinación máxima. Más de eso trabaja más hombros que pecho."
        },
        "tips": [
      ...
      },
      {
        ...
        "descripcion": "Sentado con respaldo.",
        "tecnica": {
          "postura": "Sentado con respaldo. Columna neutra. No arquear la lumbar al empujar.",
          "errores_comunes": "Chocar las mancuernas arriba. Bajar menos de lo que permite la articulación. Arquear la lumbar.",
          "seguridad": "Bajá hasta que los pulgares queden a la altura de las orejas — no más. Eso protege el hombro."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Vuelos Laterales (Dropset en última serie)",
        "grupo_muscular": "Hombros",
        "descripcion": "De pie o sentado.",
        "tecnica": {
          "postura": "De pie o sentado. Columna recta. Rodillas levemente flexionadas.",
          "errores_comunes": "Usar impulso. Subir más de la altura de los hombros. Encorvar los trapecios.",
          "seguridad": "Peso liviano y técnica impecable. Nada de ego acá."
        },
        "tips": [
      ...
      },
      {
        ...
        "descripcion": "De pie frente a la polea alta.",
        "tecnica": {
          "postura": "De pie frente a la polea alta. Ligera inclinación hacia adelante. Core activo.",
          "errores_comunes": "Mover los codos. Usar el cuerpo para ayudar. No llegar a extensión completa.",
          "seguridad": "Solo se mueve el antebrazo. Si movés los codos, estás usando otros músculos."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Pallof Press",
        "grupo_muscular": "Core",
        "descripcion": "De pie perpendicular a la polea.",
        "tecnica": {
          "postura": "De pie perpendicular a la polea. Pies a ancho de hombros. Rodillas levemente flexionadas.",
          "errores_comunes": "Rotar el tronco al extender — justamente eso es lo que debés evitar. Peso excesivo.",
          "seguridad": "Perfecto para diástasis. Trabaja el core sin presión intraabdominal alta."
        },
        "tips": [
  ...
  {
    "dia": 3,
    "titulo": "Día 3: Brazos + Core + Espalda",
    "ejercicios": [
      {
        "ejercicio_id": "gr_plancha_d3",
        "nombre": "Plancha Abdominal",
        "grupo_muscular": "Core",
        "descripcion": "Antebrazos y puntas de pie.",
        "tecnica": {
          "postura": "Antebrazos y puntas de pie. Cuerpo en línea recta. Ombligo hacia adentro.",
          "errores_comunes": "Caderas que bajan. Panza que cuelga. Doming abdominal.",
          "seguridad": "Versión con rodillas si hay doming. La forma perfecta primero siempre."
        },
        "tips": [
      ...
      },
      {
        ...
        "tecnica": {
          "postura": "Boca abajo. Mirada al piso siempre. Brazos extendidos o manos en la nuca.",
          "errores_comunes": "Mirar hacia adelante. Levantar demasiado. Hacer el movimiento rápido.",
          "seguridad": "Elevación pequeña y controlada. El objetivo es activar, no llegar alto."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Peso Muerto Convencional con Pausa",
        "grupo_muscular": "Core",
        "descripcion": "Pies a ancho de cadera.",
        "tecnica": {
          "postura": "Pies a ancho de cadera. Barra sobre los empeines. Caderas atrás, espalda neutra, pecho arriba.",
          "errores_comunes": "Redondear la espalda. Barra que se aleja del cuerpo. Tirar con los brazos.",
          "seguridad": "Cinturón con pesos altos. Empezá con técnica perfecta antes de agregar carga."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Remo Caballo Agarre Amplio",
        "grupo_muscular": "Espalda",
        "descripcion": "Inclinado ~45°.",
        "tecnica": {
          "postura": "Inclinado ~45°. Rodillas levemente flexionadas. Espalda recta. Core activo.",
          "errores_comunes": "Redondear la lumbar. Usar impulso del torso. Bajar la barra rápido.",
          "seguridad": "Con más de 80 kg, usá cinturón. Si duele la lumbar, reducí el peso."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Jalón Cerrado (Triángulo)",
        "grupo_muscular": "Espalda",
        "descripcion": "Sentado.",
        "tecnica": {
          "postura": "Sentado. Rodillas bajo el soporte. Torso levemente inclinado hacia atrás (~15°). Pecho afuera.",
          "errores_comunes": "Inclinarse demasiado atrás. Bajar más allá del pecho. Soltar rápido.",
          "seguridad": "Control total en el excéntrico. Llevá el triángulo al pecho inclinándote apenas hacia atrás."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Remo Hammer 1 Brazo",
        "grupo_muscular": "Espalda",
        "descripcion": "Apoyá la rodilla y mano libre en el banco.",
        "tecnica": {
          "postura": "Apoyá la rodilla y mano libre en el banco. Espalda paralela al suelo. Cadera sin girar.",
          "errores_comunes": "Rotar el tronco para ayudar. Usar impulso. Bajar sin control.",
          "seguridad": "Movimiento pesado pero sin girar el tronco — eso es lo que lo hace efectivo y seguro."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Jalón Abierto (Agarre Amplio)",
        "grupo_muscular": "Espalda",
        "descripcion": "Sentado.",
        "tecnica": {
          "postura": "Sentado. Barra por encima. Torso levemente hacia atrás. Pecho afuera.",
          "errores_comunes": "Inclinar demasiado el torso. No llegar al pecho. Soltar la barra rápido.",
          "seguridad": "Controlá el regreso de la barra — ese es el trabajo excéntrico."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Bíceps Barra W (Curl con Barra EZ)",
        "grupo_muscular": "Brazos",
        "descripcion": "De pie.",
        "tecnica": {
          "postura": "De pie. Columna recta. Codos pegados al cuerpo. Sin balancear.",
          "errores_comunes": "Balancear el cuerpo para ayudar. Soltar los codos del cuerpo. Bajar rápido.",
          "seguridad": "No balancees el cuerpo. Si lo hacés, el peso es demasiado."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Bíceps en Polea con Soga",
        "grupo_muscular": "Brazos",
        "descripcion": "De pie frente a polea baja.",
        "tecnica": {
          "postura": "De pie frente a polea baja. Codos pegados al cuerpo.",
          "errores_comunes": "Mover los codos. Usar el cuerpo. Bajar sin control.",
          "seguridad": "Peso ligero. Es un ejercicio de aislamiento y definición."
        },
        "tips": [
      ...
      },
      {
        ...
        "nombre": "Caminata del Granjero (Farmer Walk)",
        "grupo_muscular": "Espalda",
        "descripcion": "De pie.",
        "tecnica": {
          "postura": "De pie. Pecho arriba. Hombros atrás y abajo. Pasos cortos y controlados.",
          "errores_comunes": "Inclinarse hacia un lado. Encorvar los hombros. Pasos demasiado largos.",
  ...
  {
    "dia": 4,
    "titulo": "Día 4: Core + Espalda + Piernas",
    "ejercicios": [
      {
        "ejercicio_id": "gr_stomach_vacuum",
        "nombre": "Stomach Vacuum (Vacío Abdominal)",
        "grupo_muscular": "Core",
        "descripcion": "Sentado en silla o en cuadrupedia.",
        "tecnica": {
          "postura": "Sentado en silla o en cuadrupedia. Espalda neutra, relajada. No tensar glúteos ni piernas.",
          "errores_comunes": "Tomar aire mientras hacés el vacío. Tener la espalda arqueada. Apurar la repetición. Activar glúteos o cuádriceps.",
      ...
      },
      {
        ...
        "nombre": "Dead Bug con Press de Manos",
        "grupo_muscular": "Core",
        "descripcion": "Acostado boca arriba.",
        "tecnica": {
          ...
          "errores_comunes": "Perder el contacto de la lumbar con el suelo. Moverse rápido. No presionar las manos contra los muslos — es la clave de esta variante.",
      ...
      },
      {
        ...
        "nombre": "Side Plank en Banco (Plancha Lateral Elevada)",
        "grupo_muscular": "Espalda",
        "descripcion": "Codo apoyado en el borde del banco.",
        "tecnica": {
          ...
          "errores_comunes": "Dejar caer la cadera. Rotar el torso hacia adelante. Apoyar en la mano en vez del codo.",
      ...
      },
      {
        ...
        "nombre": "Caminata con Inclinación (Incline Walking)",
        "grupo_muscular": "Piernas",
        "descripcion": "Cinta a 5-10% de inclinación.",
        "tecnica": {
          "postura": "Cinta a 5-10% de inclinación. Velocidad 5-6 km/h. Espalda recta, no agarrarte de los laterales de la cinta.",
          "errores_comunes": "Agarrarse de los laterales. Poner la inclinación tan alta que debas doblarte. Ir demasiado rápido — esto es resistencia de base, no cardio intenso.",
  ...
  {
    "dia": 5,
    "titulo": "Día 5: Core + Hombros + Piernas",
    "ejercicios": [
      {
        "ejercicio_id": "gr_copenhague_plank",
        "nombre": "Copenhagen Plank (versión fácil con rodilla)",
        "grupo_muscular": "Piernas",
        "descripcion": "De lado.",
        "tecnica": {
          "postura": "De lado. Rodilla superior apoyada en el banco (versión fácil). Cuerpo en línea recta. Codo en el suelo.",
          "errores_comunes": "Dejar caer la cadera. Rotar el torso. Apoyar la rodilla demasiado alta o baja en el banco.",
      ...
      },
      {
        ...
        "nombre": "Caminata de Oso (Bear Crawl)",
        "grupo_muscular": "Hombros",
        "descripcion": "En cuadrupedia con las rodillas apenas despegadas del suelo (2-3 cm).",
        "tecnica": {
          "postura": "En cuadrupedia con las rodillas apenas despegadas del suelo (2-3 cm). Espalda plana como una mesa.",
          "errores_comunes": "Levantar demasiado las caderas. Dejar que las caderas oscilen de lado a lado. Moverse rápido perdiendo la postura.",
      ...
      },
      {
        ...
        "nombre": "Kettlebell Swings (o Mancuerna)",
        "grupo_muscular": "Piernas",
        "descripcion": "Pies a ancho de hombros.",
        "tecnica": {
          ...
          "errores_comunes": "Cuclillarse en vez de hacer bisagra de cadera. Usar los brazos para levantar — los brazos son el gancho, la potencia sale de los glúteos. No exhalar al subir.",
      ...
      },
      {
        ...
        "nombre": "Goblet Squat (Sentadilla Goblet)",
        "grupo_muscular": "Piernas",
        "descripcion": "Pies a ancho de hombros o algo más abiertos.",
        "tecnica": {
          "postura": "Pies a ancho de hombros o algo más abiertos. Puntas levemente hacia afuera. Pesa al pecho como un cáliz.",
          "errores_comunes": "Dejar que las rodillas colapsen hacia adentro. Talones que se levantan (movilidad de tobillo). Inclinar demasiado el torso al frente.",
      ...
      },
      {
        ...
        "nombre": "Step-ups (Subidas al Cajón)",
        "grupo_muscular": "Piernas",
        "descripcion": "Cajón o banco a altura de rodilla.",
        "tecnica": {
          "postura": "Cajón o banco a altura de rodilla. Torso erguido. Core activado antes de subir.",
          "errores_comunes": "Impulsar con la pierna de abajo — toda la fuerza debe venir de la pierna que está arriba. Inclinarse hacia adelante. Bajar rápido.",
      ...
      },
      {
        ...
        "nombre": "Intervalos de Piques — Cinta o Bici",
        "grupo_muscular": "Core",
        "descripcion": "Cinta: corré erguido, no te inclines hacia adelante.",
        "tecnica": {
          "postura": "Cinta: corré erguido, no te inclines hacia adelante. Bici: espalda neutra, no te agarres para ayudarte.",
          "errores_comunes": "Ir demasiado suave en los 30 seg de esfuerzo — tienen que ser incómodos. No recuperar bien en los 60 seg — caminá, no pares.",
      ...
      },
      {
        ...
        "nombre": "Face Pull (Bonus final — Hombros/Postura)",
        "grupo_muscular": "Hombros",
        "descripcion": "De pie frente a polea alta.",
        "tecnica": {
          "postura": "De pie frente a polea alta. Pies firmes, core activado. No arqueés la espalda al tirar.",
          "errores_comunes": "Peso excesivo que rompe la forma. No separar la cuerda al final. Tirar con los bíceps en vez de los hombros posteriores.",
